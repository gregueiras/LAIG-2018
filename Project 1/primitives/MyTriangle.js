...
class MyTriangle extends CGFobject {
	 ...
	 * @param {number} x1 the first vertice X value
	 * @param {number} x2 the second vertice X value
	 * @param {number} x3 the third vertice X value
	 * @param {number} y1 the first vertice Y value
	 * @param {number} y2 the second vertice Y value
	 * @param {number} y3 the third vertice Y value
	 * @param {number} z1 the first vertice Z value
	 * @param {number} z2 the second vertice Z value
	 * @param {number} z3 the third vertice Z value
	 * @memberof MyTriangle
	 */
